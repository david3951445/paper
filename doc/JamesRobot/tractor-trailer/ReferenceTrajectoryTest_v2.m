...
%
% 3. Compare & Result:
%   (1) Velocity: The velocity which is calculated from holonomic
%   constraints is more similar than the one calculated from nonholonomic
%   constraints.
%   (2) Angular:
...
%   (3) Position:
%       The result from nonholonomic constraint is more rationable than
...
% holonomic
x0_test = xr(1,:) + d*cos(xr(7,i)); % X
y0_test = xr(2,:) + d*sin(xr(7,i)); % X
...
phi0_test = atan(vy0_test./vx0_test); % X (is same as phi1)
