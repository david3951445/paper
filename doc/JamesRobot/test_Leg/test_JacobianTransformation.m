...
for i=1:8
figure;
plot(tr(1:20000),q(i,1:20000));
end
for i=1:8
figure;
plot(tr(1:20000),dq(i,1:20000));
end
for i=1:8
figure;
plot(tr(1:20000),ddq(i,1:20000));
end
for i = 1:8
...
for i = 1:8
figure;
plot(tr(1:20000),ddq(i,1:20000),tr(1:20000),ddq_test(i,1:20000))
end
% for i=1:6
% figure;
% plot(t,P(i,:));
