clc;clear;close all
load 'G:\我的雲端硬碟\畢業論文 進度\模擬\MATLAB\biped robot\com0_trajectory_reference_model_team_fixedlength.mat'
load 'leg_trajectory_interpolation_sample.mat'
%% only design l1 and u1.
%% defuzzy
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%
save('leg_trajectory_qr_f_l1_fixedlength','q9r_f_l1','q10r_f_l1','q11r_f_l1','q12r_f_l1','dq9r_f_l1',...
    'dq10r_f_l1','dq11r_f_l1','dq12r_f_l1','ddq9r_f_l1','ddq10r_f_l1','ddq11r_f_l1','ddq12r_f_l1');
save('leg_trajectory_qr_f_l2_fixedlength','q9r_f_l2','q10r_f_l2','q11r_f_l2','q12r_f_l2','dq9r_f_l2',...
    'dq10r_f_l2','dq11r_f_l2','dq12r_f_l2','ddq9r_f_l2','ddq10r_f_l2','ddq11r_f_l2','ddq12r_f_l2');
save('leg_trajectory_qr_f_l3_fixedlength','q9r_f_l3','q10r_f_l3','q11r_f_l3','q12r_f_l3','dq9r_f_l3',...
    'dq10r_f_l3','dq11r_f_l3','dq12r_f_l3','ddq9r_f_l3','ddq10r_f_l3','ddq11r_f_l3','ddq12r_f_l3');

save('leg_trajectory_qr_f_u1_fixedlength','q9r_f_u1','q10r_f_u1','q11r_f_u1','q12r_f_u1','dq9r_f_u1',...
    'dq10r_f_u1','dq11r_f_u1','dq12r_f_u1','ddq9r_f_u1','ddq10r_f_u1','ddq11r_f_u1','ddq12r_f_u1');
save('leg_trajectory_qr_f_u2_fixedlength','q9r_f_u2','q10r_f_u2','q11r_f_u2','q12r_f_u2','dq9r_f_u2',...
    'dq10r_f_u2','dq11r_f_u2','dq12r_f_u2','ddq9r_f_u2','ddq10r_f_u2','ddq11r_f_u2','ddq12r_f_u2');
save('leg_trajectory_qr_f_u3_fixedlength','q9r_f_u3','q10r_f_u3','q11r_f_u3','q12r_f_u3','dq9r_f_u3',...
