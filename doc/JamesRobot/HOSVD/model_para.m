...
J_bar1_3 = @(x) 0;
J_bar1_4 = @(x) 0;
J_bar1_5 = @(x) -(d^2*sin(2*x(1) - 2*x(2))*(d^2 - 1)*(cos(x(1) - 2*x(2)) ...
    + cos(x(1)))*(x(3) - x(4)))/(d^2*cos(2*x(1) - 2*x(2)) - cos(2*x(1) - 2*x(2)) + d^2 + 1)^2;
J_bar1_6 = @(x) (d^2*sin(2*x(1) - 2*x(2))*(d^2 - 1)*(x(3) - x(4))*(sin(x(1) - 2*x(2)) ...
...
J_bar1_8 = @(x) -(2*d*(d^2 - 1)*(cos(x(1) - x(2)) - ...
    ...
    + 4*d^4*cos(2*x(1) - 2*x(2)) - 2*d^2*cos(4*x(1) - 4*x(2)) + d^4*cos(4*x(1) - 4*x(2)) + 2*d^2 + 3*d^4 + 3);
J_bar1_9 = @(x) (d^2*(cos(x(1) - 2*x(2)) + cos(x(1))))/(d^2*cos(2*x(1) - 2*x(2)) - cos(2*x(1) - 2*x(2)) + d^2 + 1);
J_bar1_10 = @(x) -(d^2*(sin(x(1) - 2*x(2)) - sin(x(1))))/(d^2*cos(2*x(1) - 2*x(2)) - cos(2*x(1) - 2*x(2)) + d^2 + 1);
J_bar1_11 = @(x) 0;
J_bar1_12 = @(x) (2*d*sin(x(1) - x(2)))/(d^2*cos(2*x(1) - 2*x(2)) - cos(2*x(1) - 2*x(2)) + d^2 + 1);
J_bar2_1 = @(x) 0;
J_bar2_2 = @(x) 0;
J_bar2_3 = @(x) 0;
J_bar2_4 = @(x) 0;
...
Je12_12 = @(x) 1;
%% lpv{5,3}
S5Jt1_1 = @(x) cos(x(1) - x(2))*cos(x(2));
S5Jt1_2 = @(x) 0;
S5Jt2_1 = @(x) cos(x(1) - x(2))*sin(x(2));
S5Jt2_2 = @(x) 0;
S5Jt3_1 = @(x) sin(x(1) - x(2))/d;
S5Jt3_2 = @(x) 0;
...
Gbar1_5 = @(x) -x(11)*sin(x(10));
Gbar2_5 = @(x) x(11)*cos(x(10));
Gbar3_5 = @(x) 0;
Gbar4_5 = @(x) 0;
Gbar5_5 = @(x) 0;
Gbar6_5 = @(x) 0;
...
Gbar1_6 = @(x) x(11)*cos(x(10));
Gbar2_6 = @(x) x(11)*sin(x(10));
Gbar3_6 = @(x) 0;
Gbar4_6 = @(x) 0;
Gbar5_6 = @(x) 0;
Gbar6_6 = @(x) 0;
...
Gbar9_5 = @(x) ddq9x(x(8),x(9),x(7),S);
Gbar10_5 = @(x) ddq10x(x(8),x(9),x(7),S);
Gbar11_5 = @(x) ddq11x(x(8),x(9),x(7),S);
Gbar12_5 = @(x) ddq12x(x(8),x(9),x(7),S);

Gbar9_6 = @(x) ddq9y(x(8),x(9),x(7),S);
Gbar10_6 = @(x) ddq10y(x(8),x(9),x(7),S);
Gbar11_6 = @(x) ddq11y(x(8),x(9),x(7),S);
Gbar12_6 = @(x) ddq12y(x(8),x(9),x(7),S);
