function leg_trajectory_interpolation_qr_v3(team,robot) 

%% need to change the code, since the unit of Jacobian matrix is changed.
eval(['load("G:\我的雲端硬碟\畢業論文 進度\模擬\MATLAB\biped robot\com0_trajectory_reference_model_team' num2str(team) '_follower' num2str(robot) '.mat");']);
...
eval(['save("leg_trajectory_qr_team' num2str(team) '_follower' num2str(robot) '_l","q9r_f_l","q10r_f_l","q11r_f_l","q12r_f_l","dq9r_f_l","dq10r_f_l","dq11r_f_l","dq12r_f_l","ddq9r_f_l","ddq10r_f_l","ddq11r_f_l","ddq12r_f_l");']);
eval(['save("leg_trajectory_qr_team' num2str(team) '_follower' num2str(robot) '_u","q9r_f_u","q10r_f_u","q11r_f_u","q12r_f_u","dq9r_f_u","dq10r_f_u","dq11r_f_u","dq12r_f_u","ddq9r_f_u","ddq10r_f_u","ddq11r_f_u","ddq12r_f_u");']);
end
