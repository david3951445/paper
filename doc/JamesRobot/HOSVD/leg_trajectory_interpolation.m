...
for i = 1:length(vr)
    ...
    gait(:,i) =  [xq_r;vx_r;ax_r;zq_r;vz_r;az_r;xq_l;vx_l;ax_l;zq_l;vz_l;...
        az_l;q;dq;ddq];
    disp(i);
    
end

% gait(13,:) = xr(7,:); gait(14,:) = xr(7,:);
% gait(21,:) = xr(8,:); gait(22,:) = xr(8,:);
% gait(29,:) = xr(9,:); gait(30,:) = xr(9,:);
...
for i = 1:8
figure;
plot(t,gait_test(i,:),t,gait(i+20,:))
end
%%
for i = 1:8
figure;
plot(t,gait_test_2(i,:),t,gait(i+28,:))
end
% save leg_trajectory_interpolation.mat
