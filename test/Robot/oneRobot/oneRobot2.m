...
%% smooth model (sensor)
WINDOW = 2;
sys_s = SmoothModel(WINDOW, DIM_F, 1000*dt, '2');
sys_s.B1 = [1;1;1];
...
sys_aug1.Q1 = 10^(-3)*blkdiag(sys1.Q1, sys_a.Q1, sys_s.Q1); % weight of integral{e}, e, de, f1, f2
sys_aug1.Q2 = 10^(-3)*blkdiag(sys1.Q2, sys_a.Q2, sys_s.Q2); % weight of integral{e}, e, de, f1, f2
