...
For convenience, the distubance $d_1(t)$ in actuator fault is set as $d_1(t)=0.2\cos(t)$ and the sensor fault is set as $f_2(t)=\sin(t)$. The tracking error and fault signal estimation of UAV $\alpha_{1,1}$ are shown in Fig. \ref{fig:UAV, error, estimation}. The tracking error and error signal estimation of the robot $\alpha_{1,2}$ are shown in Fig. \ref{fig:robot, error, estimation}.
\begin{figure}[htbp]
    \centering
