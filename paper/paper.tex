...
% The behavior decision decides an appropriate behavior based on the circumstances.
...
\end{equation}
where $k_f$ is the time step when reaching goal. $(\sigma_n)$ then pass to next block, i.e., behavior decision block, as shown in Fig. \ref{fig:sys}.
